                  ...
                  dayGroup.items.map((entry) => {
                    ...
                    const cardFooter = (
                      <div className="diary-leaf-card-footer font-ui">
                        ...
                        {isMine && entry.id && (
                          <div className="diary-leaf-del-actions">
                            {isConfirming ? (
                              <div className="diary-leaf-del-confirm-group">
                                <button
                                  type="button"
                                  className="diary-del-confirm-btn"
                                  onPointerDown={(e) => e.stopPropagation()}
                                  onMouseDown={(e) => e.stopPropagation()}
                                  onTouchStart={(e) => e.stopPropagation()}
                                  onClick={(e) => {
                                ...
                                <button
                                  type="button"
                                  className="diary-del-cancel-btn"
                                  onPointerDown={(e) => e.stopPropagation()}
                                  onMouseDown={(e) => e.stopPropagation()}
                                  onTouchStart={(e) => e.stopPropagation()}
                                  onClick={(e) => {
        ...
        <DiaryPageLeaf density="hard" className="diary-back-cover-leaf">
          <div className="diary-back-cover-inner">
            ...
            <p className="diary-back-cover-text font-display">
              “A shared story where every small moment finds its place.”
            </p>
